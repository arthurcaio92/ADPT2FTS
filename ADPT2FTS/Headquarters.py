# -*- coding: utf-8 -*-
from T2FTS import Type2Model,IT2FS_plot
from Tools import error_metrics,plot_forecast 
from Partitioners import SODA_part,ADP_part,DBSCAN_part,FCM_part,ENTROPY_part,CMEANS_part,HUARNG_part
...
def T2FTS(data,method_part,mf_type,part_param,order=order,diff=diff,training=training):
